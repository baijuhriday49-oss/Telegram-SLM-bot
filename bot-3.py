...
CF_API_TOKEN    = "cfut_IXL4xoW5jerKKHe7tgQppmmDhCimw9lssH5ZqnMN3ba7e3c4"
CF_ACCOUNT_ID   = "5b0c347568a48cf9acdb794240a509da"
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text(
        "👋 Hi! I'm your AI assistant powered by Llama 3.2 1B on Cloudflare.\n"
        "/start — reset\n/clear — clear history"
    )
